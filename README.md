...
1) JETSON ORIN DEVELOPER KIT SETUP (Physical and software setup - This assumes a wifi card has already been installed and being used, or a network cable inserted which connects to your router)  
   - Remove SD card
