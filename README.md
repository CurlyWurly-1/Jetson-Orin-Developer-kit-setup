...
1) JETSON ORIN DEVELOPER KIT SETUP (Physical and software setup) 
   ...
   - Here are some notes of the actions that worked for me, based on the video above with the actions listed in sequence, but grouped by the device you need to progress the actions on
     ...
     - Ubuntu Desktop
       - Execute SDK manager and start and progress each step of the 4 step process using the manual method - Click here to see how this looks https://www.youtube.com/watch?v=Ucg5Zqm9ZMk&t=417s N.B. The Jetson Orin developer kit should be recognised and ticked "green", with a summary of the actions seen inthe video, listed as follows:
